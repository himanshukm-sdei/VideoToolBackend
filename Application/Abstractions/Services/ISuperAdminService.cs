...
namespace Application.Abstractions.Services
{
    ...
    {
        Task<bool> SaveCompanyDetails(CompanyDetails companyDetails, HttpContext context);
        ...
        Task<bool> DeleteDepartmentById(int DepartmantId);
        ...
        Task<DepartmentData> GetDepartmentById(int DepartmentId);
